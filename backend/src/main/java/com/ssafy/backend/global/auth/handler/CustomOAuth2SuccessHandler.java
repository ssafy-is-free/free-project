...
import static com.ssafy.backend.global.auth.util.HttpCookieOAuth2AuthorizationRequestRepository.OAUTH2_AUTHORIZATION_REQUEST_COOKIE_NAME;
import static com.ssafy.backend.global.auth.util.HttpCookieOAuth2AuthorizationRequestRepository.REDIRECT_URI_PARAM_COOKIE_NAME;
...
public class CustomOAuth2SuccessHandler extends SimpleUrlAuthenticationSuccessHandler {
    ...
    public void onAuthenticationSuccess(HttpServletRequest request, HttpServletResponse response, Authentication authentication) throws IOException, ServletException {
        ...
        //쿠키에 리프레시 토큰 담기.
        CookieUtils.addCookie(response, OAUTH2_AUTHORIZATION_REQUEST_COOKIE_NAME, refreshToken, REFRESH_TOKEN_VALIDATE_TIME);
...
//        OAuth2AuthorizationRequest oAuth2AuthorizationRequest = httpCookieOAuth2AuthorizationRequestRepository.loadAuthorizationRequest(request);
    ...
    public void saveRefreshToken(UserPrincipal userPrincipal, String refreshToken){
        ...
        User user = userRepository.findByIdAndIsDeletedFalse(userPrincipal.getId())
                .orElseThrow(() -> new UsernameNotFoundException("해당 유저를 찾을 수 없습니다  - 유저명 : " + userPrincipal.getUsername()));
