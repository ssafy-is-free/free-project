...
public enum CustomExceptionStatus {
	...
	NOT_FOUND_USER(ResponseStatus.FAIL, "해당하는 유저정보가 없습니다."), BOJ_DUPLICATED(ResponseStatus.FAIL,
		"이미 존재하는 아이디입니다."), NOT_FOUND_BOJ_USER(ResponseStatus.FAIL, "해당하는 백준 유저 정보가 없습니다."),
	...
	NOT_FOUND_GITHUB(ResponseStatus.FAIL, "해당하는 유저의 깃허브 정보가 없습니다."), NOT_FOUND_REPOSITORY(ResponseStatus.FAIL,
		"해당하는 리포지토리 정보가 없습니다."), INCONSISTENT_GITHUB_ID(ResponseStatus.FAIL, "깃허브 아이디가 일치하지 않습니다."),

	/* 공고 관련*/
	NOT_FOUND_JOBPOSTING(ResponseStatus.FAIL, "해당하는 공고가 존재하지 않습니다."), NOT_FOUND_APPLICANT(ResponseStatus.FAIL,
		"해당하는 공고의 지원자를 찾을 수 없습니다."), NOT_APPLY(ResponseStatus.FAIL,
		"해당 공고에 지원하지 않은 사용자는 접근할 수 없습니다."),
