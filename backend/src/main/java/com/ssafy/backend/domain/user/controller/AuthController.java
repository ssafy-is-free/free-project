...
public class AuthController {
    ...
    @GetMapping("reissue")
    public DataResponse<AccessTokenResponseDTO> reissueToken(
        ...
        AccessTokenResponseDTO accessTokenResponseDTO = authService.reissueToken(oldAccessToken, refreshToken);

        return responseService.getDataResponse(accessTokenResponseDTO, RESPONSE_SUCCESS);
    }
}
