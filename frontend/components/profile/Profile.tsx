...
import { IGithubProfile, IBojProfile, IAvatarData, IProfile } from '@/components/profile/IProfile';
...
export default function Profile({ category, userId }: IProfile) {
  ...
  return (
    <div>
      {userId && <ProfileHeader back={back} compare={compare}></ProfileHeader>}
      <ProfileDiv>
        {avatarDiv}
        <div className="info">
          {userId ? null : (
