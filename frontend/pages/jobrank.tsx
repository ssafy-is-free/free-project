const RankMenu = dynamic(() => import('@/components/common/RankMenu'), { ssr: false });
const JobUserItem = dynamic(() => import('@/components/jobrank/JobUserItem'), { ssr: false });
const MainOtherItem = dynamic(() => import('@/components/rank/MainOtherItem'), { ssr: false });
const ChartJobrank = dynamic(() => import('@/components/jobrank/ChartJobrank'), { ssr: false });
const OtherInfo = dynamic(() => import('@/components/jobrank/OtherInfo'), { ssr: false });
const JobInfo = dynamic(() => import('@/components/jobrank/JobInfo'), { ssr: false });
const SubMenu = dynamic(() => import('@/components/jobrank/Submenu'), { ssr: false });
const CompareBox = dynamic(() => import('@/components/jobrank/CompareBox'), { ssr: false });
const CompareUserBox = dynamic(() => import('@/components/jobrank/CompareUserBox'), { ssr: false });
const RankLoading = dynamic(() => import('@/components/rank/RankLoading'), { ssr: false });
const JobUerItemLoading = dynamic(() => import('@/components/jobrank/JobUserItemLoading'), { ssr: false });
